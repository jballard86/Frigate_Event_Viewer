...
│       ├── FrigateFirebaseMessagingService.kt   # FirebaseMessagingService: onNewToken → registerToken; onMessageReceived parses EventNotification; notification image from image_url or FCM payload paths (live_frame_proxy, hosted_snapshot, notification_gif); handleNew, handleSnapshotReady, handleClipReady
